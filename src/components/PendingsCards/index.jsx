...
const PendingsCards = ({
  ...
  return (
    ...
    <Container>
      <h1>Pendentes:</h1>
      {hiredPendings.length > 0 ? (hiredPendings.map((item, index) => {
    ...
    <Container>
      <h1>Aceitos: </h1>
      {acceptedPendings.length > 0 ? (acceptedPendings.map((item, index) => {
        const name = alternative ? item.hirerName : item.name;
    ...
    <Container>
      <h1>Concluidos</h1>
      {donePendings.length > 0 ? (donePendings.map((item, index) => {
        const name = alternative ? item.hirerName : item.name;
